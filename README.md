...
- Image is converted to **grayscale** and then high intensity points are recognized and the beam is signalled to change  
...
```bash
git clone https://github.com/surajy1012/Automatic-headlight-switcher.git
